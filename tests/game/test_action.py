...
@pytest.mark.parametrize("pick", [0, 1, Rules.DEFAULT.factory_count])
@pytest.mark.parametrize("color", [Tile(0), Tile(Rules.DEFAULT.tile_types-1)])
@pytest.mark.parametrize("place", [0, 1, Rules.DEFAULT.tile_types])
